                  ...
                  education.map((edu, index) => (
                    ...
                    >
                      <Card.Body className="d-flex align-items-start p-0">
                        <div className="education-icon me-3">{index + 1}</div>
                  ...
                  <Card className="education-card reveal" style={{ '--index': 0 }}>
                    <Card.Body className="d-flex align-items-start p-0">
                      ...
                      <div className="education-content flex-grow-1">
                        ...
                        <Badge className="education-badge">C1 Level | Overall Band Score</Badge>
                        <p className="education-description">{t('about.ieltsDescription')}</p>
                      </div>
                    </Card.Body>
                  </Card>
                )}
              ...
              <Col md={6} lg={4}>
                <Card className="interest-card text-center reveal" style={{ '--index': 0 }}>
                  <Card.Body>
                    ...
                    <p className="interest-description">{t('about.webDev.description')}</p>
                  </Card.Body>
                </Card>
              </Col>
              <Col md={6} lg={4}>
                <Card className="interest-card text-center reveal" style={{ '--index': 1 }}>
                  <Card.Body>
                    ...
                    <p className="interest-description">{t('about.mobileDev.description')}</p>
                  </Card.Body>
                </Card>
              </Col>
              <Col md={6} lg={4}>
                <Card className="interest-card text-center reveal" style={{ '--index': 2 }}>
                  <Card.Body>
                    ...
                    <p className="interest-description">{t('about.softwareEng.description')}</p>
                  </Card.Body>
                </Card>
              </Col>
            </Row>
